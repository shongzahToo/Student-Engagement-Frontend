...
function App() {
  ...
  //data objects are used to avoid reloading and hitting the database when it isnt neccissary.
  ...
  return (
    <>
      ...
      <Routes> 
        ...
        <Route path="/events/:id/scan" element={ <ScanUsers user={userPassObject}/> } />
        ...
        <Route path="/clubs/:id/create-event" element={ <CreateEvent user={userPassObject} clubs={clubsPassObject} events={eventsPassObject}/> } />
        <Route path="/admin" element={<Admin events={eventsPassObject} clubs={clubsPassObject} users={usersPassObject} user={userPassObject}/>} />
      </Routes>
    </>
  );
}
